...
{{- if or .Values.existingSecret .Values.credentials.mqtt.username .Values.credentials.mqtt.password .Values.credentials.pdu.username .Values.credentials.pdu.password .Values.credentials.emoncmsApiKey .Values.credentials.oidcClientSecret .Values.credentials.apiKey .Values.credentials.hassToken .Values.credentials.cachePassword .Values.credentials.guiPassword .Values.credentials.plansSecretKey -}}
true
{{- end -}}
{{- end -}}
